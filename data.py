...
class CelebA(data.Dataset):
    def __init__(self, data_path, attr_path, image_size, mode, selected_attrs, stargan_selected_attrs):
        ...
        self.train_end = 1000
        self.val_end = 1200
        # self.test_start = 2300
        # self.test_end = 2400
        self.test_start = 1200
        self.test_end = 1300
        ...
        if self.mode == 'test':
            # self.images = images[182637:]
            # self.labels = labels[182637:]
            self.images = images[self.test_start:self.test_end]
            self.labels = labels[self.test_start:self.test_end]
            # self.images = images[28000:]
            # self.labels = labels[28000:]
        
        # self.tf = transforms.Compose([
        #     # transforms.CenterCrop(170), # 不需要crop裁剪
    ...
    def preprocess(self):
        ...
        for i, line in enumerate(lines):
            ...
            elif self.test_start < i+1 <= self.test_end:
